    ...
    async def lab(self, ctx, difficulty: str=None):
        ...
        for k in LAB_EMBEDS.keys():
            ...
            async def swap_to(interaction, key = k, btn=button):
                ...
                btn.disabled=True
                view.message = await interaction.edit_original_response(content = None, embed = LAB_EMBEDS[key], view=view)
